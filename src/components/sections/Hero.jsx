...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="font-clash text-center font-medium text-[30px] ssm:text-[34px] xsm:text-[40px] sm:text-[50px] md:text-[60px] mmd:text-[75px]  lg:text-[85px] xl:text-[100px] 2xl:text-[120px]  absolute center w-full -mt-3 xl:-mt-7  ">
