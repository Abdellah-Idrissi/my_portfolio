...
const SheetOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-[100] bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 hidden",
      className
    )}
    {...props}
    ref={ref} />
...
const sheetVariants = cva(
  "fixed z-[100] gap-4 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-700 data-[state=open]:duration-700",
  {
    variants: {
      side: {
  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
      ...
      {/* <SheetPrimitive.Close
        ...
        <span className="sr-only close">Close</span>
      </SheetPrimitive.Close> */}
