...
export default function NavMenu() {
  ...
  return (
    <motion.div
      ...
      animate={"animate"}
      exit={"exit"}
      className={`${pathname === '/' ? 'navmenu_gradient z-[2000]' : 'navmenu_gradient2 z-[100]'} grid place-items-center p-5 md:p-6 lg:p-8 xl:p-10  fixed top-0 left-0 dynamicHeight2 dynamicMaxMenuHeight inset-x-0 origin-top`}
    >
      <div
